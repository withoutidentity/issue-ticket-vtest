                    ...
                    <div v-if="isFilterDropdownOpen"
                      ...
                      <ul class="py-1">
                        <li @click="applyFilter('visibility', 'active')"
                          class="px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 cursor-pointer"
                          :class="{ 'bg-blue-100': visibilityFilter === 'active' }">แสดงรายการปกติ</li>
                        <li @click="applyFilter('visibility', 'hidden')"
                          class="px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 cursor-pointer"
                          :class="{ 'bg-blue-100': visibilityFilter === 'hidden' }">แสดงรายการที่จัดเก็บ</li>
                        <li @click="applyFilter('visibility', 'all')"
                          class="px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 cursor-pointer"
                          :class="{ 'bg-blue-100': visibilityFilter === 'all' }">แสดงทั้งหมด</li>
                      </ul>
                    </div>
                  </div>
...
const hideSelectedTickets = async () => {
  ...
  const confirmResult = await Swal.fire({
    ...
    text: `คุณต้องการจัดเก็บ Ticket ที่เลือกจำนวน ${countSelected.value} รายการใช่หรือไม่? รายการที่จัดเก็บจะไม่แสดงในรายการหลัก`,
    icon: 'warning',
